 ...
 */
export function convertHtmlToXhtml(html: string, options: HtmlConvertOptions = {}): string {
  const { stripDocumentStructure = true, processImages = true, processLinks = true } = options
