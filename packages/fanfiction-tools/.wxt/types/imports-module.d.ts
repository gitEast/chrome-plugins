...
declare module '#imports' {
  ...
  export { createEpub } from '../src/utils/create-epub';
  export { parseStoryUrl, getChapterCount, getChapterTitles, fetchAllChapters, ChapterData } from '../src/utils/fetch-chapters';
}
