...
declare global {
  ...
  const createEpub: typeof import('F:/chrome-plugins/packages/fanfiction-tools/src/utils/create-epub').createEpub
  ...
  const fetchAllChapters: typeof import('F:/chrome-plugins/packages/fanfiction-tools/src/utils/fetch-chapters').fetchAllChapters
  const getAppConfig: typeof import('wxt/utils/app-config').getAppConfig
  const getChapterCount: typeof import('F:/chrome-plugins/packages/fanfiction-tools/src/utils/fetch-chapters').getChapterCount
  const getChapterTitles: typeof import('F:/chrome-plugins/packages/fanfiction-tools/src/utils/fetch-chapters').getChapterTitles
  const injectScript: typeof import('wxt/utils/inject-script').injectScript
  const parseStoryUrl: typeof import('F:/chrome-plugins/packages/fanfiction-tools/src/utils/fetch-chapters').parseStoryUrl
...
declare global {
  ...
  // @ts-ignore
  export type { ChapterData } from 'F:/chrome-plugins/packages/fanfiction-tools/src/utils/fetch-chapters'
  import('F:/chrome-plugins/packages/fanfiction-tools/src/utils/fetch-chapters')
}
